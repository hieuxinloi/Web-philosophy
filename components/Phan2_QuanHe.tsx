...
export default function Phan2_QuanHe() {
  const accordionItems = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <div className="border-l-4 border-green-500 bg-green-50/50 pl-4 mb-3">
            <p className="font-semibold text-slate-800 mb-2">Thống nhất:</p>
            <ul className="text-slate-700 text-sm space-y-1">
              <li>• Cùng nhau hợp tác trong dây chuyền sản xuất</li>
              <li>• Cùng nhau đoàn kết (thông qua Công đoàn) đòi quyền lợi</li>
            </ul>
          </div>
          <div className="border-l-4 border-red-500 bg-red-50/50 pl-4">
            <p className="font-semibold text-slate-800 mb-2">Mâu thuẫn:</p>
            <ul className="text-slate-700 text-sm space-y-1">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="border-l-4 border-green-500 bg-green-50/50 pl-4">
            <p className="font-semibold text-slate-800 mb-2">Hài hòa (Lý tưởng):</p>
          ...
          <div className="border-l-4 border-red-500 bg-red-50/50 pl-4">
            <p className="font-semibold text-slate-800 mb-2">Mâu thuẫn (Tiêu cực):</p>
            <p className="text-gray-700 text-sm mb-2">
              Hiện tượng "lợi ích nhóm" tiêu cực.
            </p>
            <p className="text-slate-700 text-sm">
              <strong className="text-slate-800">Dẫn chứng:</strong> Các vụ án như Việt Á, "chuyến bay giải cứu". 
  ...
  return (
    <Section id="quan-he" className="border-t border-blue-300 bg-gradient-to-b from-blue-100 via-white to-blue-50 pt-32">
      <div className="space-y-16">
        {/* Tiêu đề phần */}
        <div className="text-center space-y-4">
          <h2 className="text-4xl md:text-5xl font-bold">
            <span className="text-slate-800">Phần 2: </span>
            <span className="bg-gradient-to-r from-blue-800 via-blue-700 to-blue-900 bg-clip-text text-transparent">Quan hệ lợi ích kinh tế</span>
          </h2>
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card hover className="bg-white border-2 border-blue-300 shadow-lg rounded-xl">
              <h4 className="text-xl font-bold mb-4 text-green-600">a. Sự thống nhất</h4>
              ...
              <div className="border-l-4 border-green-500 bg-green-50/50 pl-4 rounded-r-lg shadow-sm">
                <p className="font-semibold text-slate-800 mb-1">Dẫn chứng (Giữa Doanh nghiệp và Người lao động):</p>
            ...
            <Card hover className="bg-white border-2 border-blue-300 shadow-lg rounded-xl">
              <h4 className="text-xl font-bold mb-4 text-red-600">b. Sự mâu thuẫn</h4>
              <p className="text-slate-700 mb-4">
              ...
              <div className="border-l-4 border-red-500 bg-red-50/50 pl-4 rounded-r-lg shadow-sm mt-4">
                <p className="font-semibold text-slate-800 mb-1">Dẫn chứng 1 (Giữa Doanh nghiệp và Người lao động):</p>
                <p className="text-sm text-slate-700 mb-2">
              ...
              <div className="border-l-4 border-red-500 bg-red-50/50 pl-4 rounded-r-lg shadow-sm mt-4">
                <p className="font-semibold text-slate-800 mb-1">Dẫn chứng 2 (Giữa các nhóm lợi ích):</p>
                <p className="text-sm text-slate-700 mb-2">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-white border-2 border-blue-300 shadow-lg rounded-xl">
              <div className="space-y-4">
                <div>
                  <h4 className="text-xl font-semibold mb-3 text-blue-900">a. Trình độ phát triển của lực lượng sản xuất</h4>
                ...
                <div className="bg-gradient-to-r from-blue-100 to-blue-50 p-4 rounded-lg border-l-4 border-blue-700 shadow-sm">
                  <p className="text-sm text-slate-700 leading-relaxed">
                    <strong className="text-blue-900">Dẫn chứng:</strong> Cuộc cách mạng 4.0 (LLSX) tạo ra nhóm lao động tri thức (IT, AI) có LIKT (thu nhập) cao vượt trội so với lao động giản đơn.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-white border-2 border-blue-300 shadow-lg rounded-xl">
              <div className="space-y-4">
                <div>
                  <h4 className="text-xl font-semibold mb-3 text-blue-900">b. Địa vị của chủ thể trong hệ thống quan hệ sản xuất xã hội</h4>
                  <p className="text-slate-700 text-sm leading-relaxed mb-4">
                ...
                <div className="bg-gradient-to-r from-blue-100 to-blue-50 p-4 rounded-lg border-l-4 border-blue-700 shadow-sm">
                  <p className="text-sm text-slate-700 leading-relaxed">
                    <strong className="text-blue-900">Dẫn chứng:</strong> Trong một công ty cổ phần, cổ đông (chủ sở hữu vốn) nhận lợi tức, ban giám đốc nhận lương và thưởng hiệu suất, còn người lao động nhận tiền công. Địa vị khác nhau dẫn đến phương thức nhận LIKT khác nhau.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-white border-2 border-blue-300 shadow-lg rounded-xl">
              <div className="space-y-4">
                <div>
                  <h4 className="text-xl font-semibold mb-3 text-blue-900">c. Chính sách phân phối thu nhập của nhà nước</h4>
                  <p className="text-slate-700 text-sm leading-relaxed mb-4">
                ...
                <div className="bg-gradient-to-r from-blue-100 to-blue-50 p-4 rounded-lg border-l-4 border-blue-700 shadow-sm">
                  <p className="text-sm text-slate-700 leading-relaxed">
                    <strong className="text-blue-900">Dẫn chứng:</strong> Thuế thu nhập cá nhân lũy tiến (người có thu nhập cao đóng thuế nhiều hơn) và các chương trình hỗ trợ người nghèo, bảo hiểm xã hội, y tế công giúp giảm bớt khoảng cách giàu nghèo, đảm bảo người có thu nhập thấp vẫn có cơ hội tiếp cận các dịch vụ cơ bản.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-white border-2 border-blue-300 shadow-lg rounded-xl">
              <div className="space-y-4">
                <div>
                  <h4 className="text-xl font-semibold mb-3 text-blue-900">d. Hội nhập kinh tế quốc tế</h4>
                  <p className="text-slate-700 text-sm leading-relaxed mb-4">
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card hover className="bg-white border-2 border-blue-300 shadow-lg rounded-xl">
              <h4 className="text-xl font-bold mb-4 text-blue-900">Thực hiện LIKT theo nguyên tắc thị trường</h4>
              <p className="text-slate-700 mb-4 leading-relaxed">
                Đây là phương thức chủ yếu. LIKT được xác lập thông qua cạnh tranh, cung - cầu, giá cả tự do.
              </p>
              <div className="bg-gradient-to-r from-blue-100 to-blue-50 p-3 rounded-lg border-l-4 border-blue-700 mt-4 shadow-sm">
                <p className="text-sm text-slate-700">
                  <strong className="text-blue-900">Ví dụ:</strong> Giá một căn hộ chung cư được quyết định bởi cung (số lượng dự án) 
            ...
            <Card hover className="bg-white border-2 border-blue-300 shadow-lg rounded-xl">
              <h4 className="text-xl font-bold mb-4 text-blue-900">Thực hiện LIKT theo chính sách Nhà nước và vai trò của tổ chức xã hội</h4>
              <p className="text-slate-700 mb-4 leading-relaxed">
                Nhà nước can thiệp để điều tiết những LIKT mang tính đặc thù, hoặc sửa chữa khuyết tật thị trường.
              </p>
              <div className="bg-gradient-to-r from-blue-100 to-blue-50 p-3 rounded-lg border-l-4 border-blue-700 mt-4 shadow-sm">
                <p className="text-sm text-slate-700">
                  <strong className="text-blue-900">Ví dụ:</strong> Nhà nước quy định giá trần cho vé máy bay, giá sàn cho lúa gạo 
